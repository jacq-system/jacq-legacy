 ...
 * changed since 0.2.0                                                       *
 *     o deleted unused "font" and "fontsize"                                *
 ****************************************************************************/
...
{
    //Private properties
    public bool $nameIsID;         // when set to true, the param $name is used to set the id
    public array $cssfImages;     // path to the used images
    public int $tabindex = 1;
    public bool $yrelative = false;
    public bool $doEcho = true;
    public int $yrel = 0;
    ...
    public function setYRelative(bool $yrelative): void
    {
        $this->yrelative = $yrelative;
    }

    public function setEcho(bool $doEcho): void
    {
        $this->doEcho = $doEcho;
    }
    ...
    public function label($x, $y, $label, $link = "", $id = ""): void
    {
        if ($this->yrelative) {
            $y += $this->yrel;
        }
    ...
    public function labelMandatory($x, $y, $width, $label, $link = ""): void
    {
        if ($this->yrelative) {
            $y += $this->yrel;
        }
    ...
    public function buttonLink($x, $y, $text, $link, $newwindow, $bgcol = ""): void
    {
    ...
    public function buttonJavaScript($x, $y, $text, $js, $bgcol = "", $name = ""): void
    {
        $this->_divclass($x, $y, "cssfinput");
        print "<input tabindex=\"$this->tabindex\" class=\"cssfbutton\"";
        if ($bgcol) {
    ...
    public function buttonSubmit($x, $y, $name, $text, $bgcol = ""): void
    {
        $this->_divclass($x, $y, "cssfinput");
        print "<input tabindex=\"$this->tabindex\" class=\"cssfbutton\"";
        if ($bgcol) {
    ...
    public function buttonReset($x, $y, $text, $bgcol = ""): void
    {
        $this->_divclass($x, $y, "cssfinput");
        print "<input tabindex=\"$this->tabindex\" class=\"cssfbutton\"";
        if ($bgcol) {
    ...
    public function checkbox($x, $y, $name, $ischecked, $ignoretab = false): void
    {
    ...
    public function checkboxJavaScript($x, $y, $name, $ischecked, $js): void
    {
        $this->_divclass($x - 0.2, $y + 0.1, "cssfinput");
    ...
    public function editDropdown($x, $y, $w, $name, $value, $options, $maxsize = 0, $jump = 0, $bgcol = "", $title = "", $js = ""): void
    {
        $yh = $y + 1.7;
     ...
     * @param integer $maxsize [optional] maxsize-parameter of input-box
     * @param string $bgcol [optional] background-color
    ...
    public function inputJqAutocomplete($x, $y, $w, $name, $value, $index, $serverScript, $maxsize = 0, $minLength = 1, $bgcol = "", $title = "", $autoFocus = false, $zeroOnEmpty = false, $class_attribute = ""): void
    {
    ...
    public function inputJqAutocomplete2($x, $y, $w, $name, $index, $serverScript, $maxsize = 0, $minLength = 1, $bgcol = "", $title = "", $mustmatch = 0, $fullFocus = false, $idequval = 0, $textarea = 0)
    {
        ...
        if ($this->doEcho) {
            ...
            $res = array();
            if ($val == '' && $index != '') {
                if (str_contains($pi['path'], 'index_jq_autocomplete_commoname.php')) {
                ...
                if (count($res) == 1) {
                    if (isset($res[0]['value']) && isset($res[0]['id'])) {
                        $val = $res[0]['value'];
                        $index = $res[0]['id'];
                        $acdone = 1;
                    }
...
EOF;
    ...
    public function inputMapLines($x, $y, $asdialog, $label, $title, $serverACL, $serverACR, $callbackUrl, $serverParams, $searchjs, $searchhtml, $cols = 2): void
    {
        ?>
...
EOF;
        ...
        <div id="dialog-confirm" title="Delete Item?" style="display:none;">
            ...
            <div style="float:left"><span id="dialog-confirm-t"></span>This Item will be deleted. Are you sure?</div>
            </p>
        </div>
...
EOF;
        ...
        <div id="editAccordion">
            ...
            <div>
                <form id="searchLineForm" onsubmit="return false;">
                    ...
                    <div style="float:left;margin-left:10px;" id="PageInfo2"></div>
        ...
        <div style="display:none">
            ...
            <div id="dialog-information" title="Information">
                <p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span></p>
                <div id="dinformation" style="float:left"> These items will be permanently deleted and cannot be
                                                           recovered. Are you sure?
                </div>
            </div>
            <div id="dialog-warning" title="Warning">
                <p><span class="ui-icon ui-icon-notice" style="float:left; margin:0 7px 20px 0;"></span></p>
                <div id="dwarning" style="float:left">These items will be permanently deleted and cannot be recovered.
                                                      Are you sure?
                </div>
            </div>
            <div id="dialog-error" title="Error">
                <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span></p>
                <div id="derror" style="float:left">These items will be permanently deleted and cannot be recovered. Are
                                                    you sure?
                </div>
            </div>
    ...
    public function inputDate($x, $y, $name, $value, $us): void
    {
        $tmp = explode("-", $value);
        $this->_divclass($x, $y, "cssfinput");
        if ($us) {
    ...
    public function inputText($x, $y, $w, $name, $value, $maxsize = 0, $bgcol = "", $title = "", $readonly = '', $disabled = ''): void
    {
        $this->_divclass($x, $y, "cssfinput");
        print "<input  tabindex=\"$this->tabindex\" class=\"cssftext\" style=\"width: " . $w . "em;";
        if ($bgcol) {
    ...
    public function inputPassword($x, $y, $w, $name, $maxsize = 0, $bgcol = "", $title = ""): void
    {
        $this->_divclass($x, $y, "cssfinput");
        print "<input  tabindex=\"$this->tabindex\" class=\"cssftext\" style=\"width: " . $w . "em;";
        if ($bgcol) {
    ...
    function text($x, $y, $text, $id = ""): void
    {
    ...
    public function textarea($x, $y, $w, $h, $name, $value, $bgcol = "", $title = "", $readonly = ''): void
    {
