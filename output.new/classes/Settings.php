...
{
    $db = strtoupper($db);
    if (isset($this->options['DATABASES'][$db])) {
        return array('host' => $this->options['DATABASES'][$db]['host'],
                     'user' => $this->options['DATABASES'][$db]['readonly']['user'],
                     'pass' => $this->options['DATABASES'][$db]['readonly']['pass'],
                     'db'   => $this->options['DATABASES'][$db]['db']);
    } else {
        return array('host' => '',
                     'user' => '',
                     'pass' => '',
