...
function taxonAccepted($row)
{
    ...
    if ($row['epithet1_a']) {
        $text .= " subsp. " . $row['epithet1_a'] . " " . $row['author1_a'];
    }
    if ($row['epithet2_a']) {
        $text .= " var. " . $row['epithet2_a'] . " " . $row['author2_a'];
    }
    if ($row['epithet3_a']) {
        $text .= " subvar. " . $row['epithet3_a'] . " " . $row['author3_a'];
    }
    if ($row['epithet4_a']) {
        $text .= " forma " . $row['epithet4_a'] . " " . $row['author4_a'];
    }
    if ($row['epithet5_a']) {
        $text .= " subforma " . $row['epithet5_a'] . " " . $row['author5_a'];
    }
