                    ...
                    while ($row = mysql_fetch_array($res)) {
                        ...
                        if ($found) {
                            if ($row['synID']) {
                                ...
                                if ($row2['epithet1'])
                                    $syn .= " subsp. " . $row2['epithet1'] . " " . $row2['author1'];
                                if ($row2['epithet2'])
                                    $syn .= " var. " . $row2['epithet2'] . " " . $row2['author2'];
                                if ($row2['epithet3'])
                                    $syn .= " subvar. " . $row2['epithet3'] . " " . $row2['author3'];
                                if ($row2['epithet4'])
                                    $syn .= " forma " . $row2['epithet4'] . " " . $row2['author4'];
                                if ($row2['epithet5'])
                                    $syn .= " subforma " . $row2['epithet5'] . " " . $row2['author5'];
                                $synID = $row2['taxonID'];
                            } else {
                                $syn = '';
                                $synID = 0;
                            ...
                            $taxon = $val['genus'];
                            if ($row['epithet0'])
                                $taxon .= " " . $row['epithet0'] . " " . $row['author0'];
                            if ($row['epithet1'])
                                $taxon .= " subsp. " . $row['epithet1'] . " " . $row['author1'];
                            if ($row['epithet2'])
                                $taxon .= " var. " . $row['epithet2'] . " " . $row['author2'];
                            if ($row['epithet3'])
                                $taxon .= " subvar. " . $row['epithet3'] . " " . $row['author3'];
                            if ($row['epithet4'])
                                $taxon .= " forma " . $row['epithet4'] . " " . $row['author4'];
                            if ($row['epithet5'])
                                $taxon .= " subforma " . $row['epithet5'] . " " . $row['author5'];
    ...
    public function getMatchesCommonNames($searchtext, $withNearMatch = false) {
        ...
        foreach ($searchItems as $searchItem) {
            ...
            while ($row = mysql_fetch_array($res)) {
                ...
                if ($speciesData['epithet0'])
                    $taxon .= " " . $speciesData['epithet0'] . " " . $speciesData['author0'];
                if ($speciesData['epithet1'])
                    $taxon .= " subsp. " . $speciesData['epithet1'] . " " . $speciesData['author1'];
                if ($speciesData['epithet2'])
                    $taxon .= " var. " . $speciesData['epithet2'] . " " . $speciesData['author2'];
                if ($speciesData['epithet3'])
                    $taxon .= " subvar. " . $speciesData['epithet3'] . " " . $speciesData['author3'];
                if ($speciesData['epithet4'])
                    $taxon .= " forma " . $speciesData['epithet4'] . " " . $speciesData['author4'];
                if ($speciesData['epithet5'])
                    $taxon .= " subforma " . $speciesData['epithet5'] . " " . $speciesData['author5'];

                if (isset($speciesData['synID']) && $speciesData['synID']) {
                    $synData = $this->_getTaxonPartsOfSpecies($speciesData['synID']);
                    $syn = $synData['genus'];
                    if ($synData['epithet0'])
                        $syn .= " " . $synData['epithet0'] . " " . $synData['author0'];
                    if ($synData['epithet1'])
                        $syn .= " subsp. " . $synData['epithet1'] . " " . $synData['author1'];
                    if ($synData['epithet2'])
                        $syn .= " var. " . $synData['epithet2'] . " " . $synData['author2'];
                    if ($synData['epithet3'])
                        $syn .= " subvar. " . $synData['epithet3'] . " " . $synData['author3'];
                    if ($synData['epithet4'])
                        $syn .= " forma " . $synData['epithet4'] . " " . $synData['author4'];
                    if ($synData['epithet5'])
                        $syn .= " subforma " . $synData['epithet5'] . " " . $synData['author5'];
