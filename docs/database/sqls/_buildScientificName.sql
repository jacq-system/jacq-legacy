CREATE DEFINER=`root`@`localhost` FUNCTION `_buildScientificName`(`p_taxonID` INT(11), `p_bNoAuthor` TINYINT(1) UNSIGNED) RETURNS varchar(255) CHARSET utf8
    READS SQL DATA
BEGIN
