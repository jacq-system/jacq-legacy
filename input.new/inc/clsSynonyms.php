 ...
 * TODO: the whole class seems to be unused, check
 *
...
public function getCloud ($taxonID)
{
    ...
    $result = dbi_query("SELECT ts.taxonID, ts.synID, tst.statusID,
                         FROM tbl_tax_species ts
                          LEFT JOIN tbl_tax_status tst ON tst.statusID = ts.statusID
                         WHERE ts.taxonID = '$taxonID'");
    if (mysqli_num_rows($result) == 0) return array();  // nothing found
