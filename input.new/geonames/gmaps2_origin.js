...
function getResultTable() {
    ...
    listHtml = listHtml + '<tr class=tfooter><td colspan=5>Export : csv <a href="javascript:exportGeodata(\'csv\');" title="export as character separated values file"><img src=/img/ico_file_csv.png border=0></a>';
