...
{
    echo "<select class=\"w3-select w3-border\" size=\"1\" name=\"collection\">\n";
...
function makeDropdownUsername()
{
    ...
    $result = dbi_query($sql);
    echo "<select class=\"w3-select w3-border\" size='1' name='userID' onchange='jaxon_getUserDate(document.fm2.userID.options[document.fm2.userID.selectedIndex].value)'>\n";
...
function makeDropdownDate($label = false)
{
    ...
    echo "<select class=\"w3-select w3-border\" size='1' ";
    if ($label) {
...
<html lang="en">
<head>
  <title>JACQ - list Specimens</title>
...
<div class ="w3-display-topright jacq-right">
    <button class="w3-button w3-theme" onclick="self.close()" ><i class='material-icons'>close</i><br>close</button>
</div>


<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="fm1" id="fm1">

<div class="w3-container w3-theme w3-row-padding jacq-list-specimens-form">
    <div class="w3-container">
        <div class="w3-container w3-third">
                <label><b><a href="#" id="lblInstitutionCollection" onclick="toggleInstitutionCollection();"><?php echo ($_SESSION['wuCollection'] > 0) ? 'Collection:' : 'Institution:'; ?></a></b></label>
                <div id="drpInstitutionCollection" ><?php ($_SESSION['wuCollection'] > 0) ? makeDropdownCollection() : makeDropdownInstitution(); ?></div>
        </div>
        <div class="w3-container w3-third">
                <label><b>Herbar Nr.:</b></label>
                <input class="w3-input w3-border" type="text" name="number" value="<?php echoSpecial('sNumber', 'SESSION'); ?>">
        </div>
        <div class="w3-container w3-third">
                <label><b>Series:</b></label>
                <input class="w3-input w3-border" type="text" name="series" value="<?php echoSpecial('sSeries', 'SESSION'); ?>">
        </div>
    </div>
    ...
    <div class="w3-container">
        <div class="w3-container w3-third">
                ...
                <input class="w3-input w3-border" type="text" name="family" value="<?php echoSpecial('sFamily', 'SESSION'); ?>">
        </div>
        <div class="w3-container w3-third">
                <label><b>Taxon:</b></label>
                <input class="w3-input w3-border" type="text" name="taxon" value="<?php echoSpecial('sTaxon', 'SESSION'); ?>">
        </div>
        <div class="w3-container w3-third">
                <label><b>ident. history:</b></label>
                <input class="w3-input w3-border" type="text" name="taxon_alt" value="<?php echoSpecial('sTaxonAlt', 'SESSION'); ?>">
        </div>
    </div>
    ...
    <div class="w3-container">
        <div class="w3-container w3-third">
                ...
                <input class="w3-input w3-border" type="text" name="collector" value="<?php echoSpecial('sCollector', 'SESSION'); ?>">
        </div>
        <div class="w3-container w3-third">
                <label><b>Number:</b></label>
                <input class="w3-input w3-border" type="text" name="numberC" value="<?php echoSpecial('sNumberC', 'SESSION'); ?>">
        </div>
        <div class="w3-container w3-third">
                <div><label><b>Date:</b></label></div>
                <div><input class="w3-input w3-border" type="text" name="date" value="<?php echoSpecial('sDate', 'SESSION'); ?>"></div>
        </div>
    </div>
    ...
    <div class="w3-container">
        <div class="w3-container w3-third">
                ...
                <select class="w3-select w3-border" size="1" name="geo_general">
                    <option></option>
                    <?php
        ...
        <div class="w3-container w3-third">
                ...
                <select class="w3-select w3-border" size="1" name="geo_region">
                    <option></option>
                    <?php
        ...
        <div class="w3-container w3-third">
                <label><b>Loc.:</b></label>
                <input class="w3-input w3-border" type="text" name="loc" value="<?php echoSpecial('sLoc', 'SESSION'); ?>">
        </div>
    </div>
    ...
    <div class="w3-container">
        <div class="w3-container w3-third">
                ...
                <input class="w3-input w3-border" type="text" name="country" value="<?php echoSpecial('sCountry', 'SESSION'); ?>">
        </div>
        <div class="w3-container w3-third">
                <label><b>State/Province:</b></label>
                <input class="w3-input w3-border" type="text" name="province" value="<?php echoSpecial('sProvince', 'SESSION'); ?>">
        </div>
        <div class="w3-container w3-third">
                <label><b>Annotation:</b></label>
                <input class="w3-input w3-border" type="text" name="annotations" value="<?php echoSpecial('sBemerkungen', 'SESSION'); ?>">
        </div>
    </div>
    
    <div class="w3-container">
        <div class="w3-container w3-third">
                <input class="w3-radio" type="radio" name="typ" value="all"<?php if(!$_SESSION['sTyp']) echo " checked"; ?>>
                <label><b>All records</b></label>
                <input class="w3-radio" type="radio" name="typ" value="only"<?php if($_SESSION['sTyp']) echo " checked"; ?>>
                <label><b>Type records only</b></label>
        </div>
        <div class="w3-container w3-third">
                <label><b>Images:</b></label>
                <input class="w3-radio" type="radio" name="images" value="only"<?php if($_SESSION['sImages'] == 'only') echo " checked"; ?>>
                <label><b>Yes</b></label>
            <input class="w3-radio" type="radio" name="images" value="no"<?php if($_SESSION['sImages'] == 'no') echo " checked"; ?>>
            <label><b>No</b></label>
            <input class="w3-radio" type="radio" name="images" value="all"<?php if($_SESSION['sImages'] != 'only' && $_SESSION['sImages'] != 'no') echo " checked"; ?>>
            <label><b>All</b></label>
        </div>
    </div>
    ...
    <div class="w3-container w3-row">
        <div class="w3-container w3-col w3-mobile jacq-w15p">
            <input class="w3-button w3-theme-d2 jacq-button-margin" type="submit" name="search" value=" search ">
        </div>
        <div class="w3-container w3-col w3-mobile jacq-w70p">
            <button class="w3-button w3-theme-d2 jacq-button-margin" onclick="document.location.href='listSpecimensExport.php?select=list&type=csv';return false;" name="downloadCSV"><i class='material-icons'>file_download</i> CSV</button>
            <button class="w3-button w3-theme-d2 jacq-button-margin" onclick="document.location.href='listSpecimensExport.php?select=list&type=xslx';return false;" name="downloadCSV"><i class='material-icons'>file_download</i> XLSX</button>
            <button class="w3-button w3-theme-d2 jacq-button-margin" onclick="document.location.href='listSpecimensExport.php?select=list&type=ods';return false;" name="downloadCSV"><i class='material-icons'>file_download</i> ODS</button>
        </div>
        <div class="w3-container w3-col w3-mobile jacq-w15p">
            <?php if (checkRight('specim')): ?>
            <input class="w3-button w3-theme-d2 jacq-button-margin" type="button" value="new entry" onClick="self.location.href='editSpecimens.php?sel=<0>&new=1'">
            <?php endif; ?>
        </div>
    </div>
</div>
...
<!-- <input class="w3-button w3-theme" type="button" value="  X " onclick="self.close()" id="close"> -->
...
<!-- <tr>
  ...
  <td colspan="3">
      <input class="w3-button w3-theme" type="submit" name="search" value=" search ">
      <input class="w3-button w3-theme" type="button" onclick="document.location.href='listSpecimensExport.php?select=list&type=csv';return false;" name="downloadCSV" value=" download CSV ">
      <input class="w3-button w3-theme" type="button" onclick="document.location.href='listSpecimensExport.php?select=list&type=xslx';return false;" name="downloadXLSX" value=" download XLSX ">
      <input class="w3-button w3-theme" type="button" onclick="document.location.href='listSpecimensExport.php?select=list&type=ods';return false;" name="downloadODS" value=" download ODS ">
  </td>
  <td colspan="1" align="right">
  </td>
  <td colspan="2" align="right">
    <?php if (checkRight('specim')): ?>
    <input class="w3-button w3-theme" type="button" value="new entry" onClick="self.location.href='editSpecimens.php?sel=<0>&new=1'">
    <?php endif; ?>
  </td>
</tr>
</table> -->
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="fm2">
    <div class="w3-container w3-third w3-row">
        <div class="w3-col jacq-w70p"><label><b>SpecimenID:</b></label> <input class= "w3-input w3-border" type="text" name="specimen" value="<?php echoSpecial('specimen', 'POST'); ?>"></div>
        <div class="w3-col jacq-w30p"><br><input class="w3-button w3-theme jacq-button-margin1" type="submit" name="select" value="Edit"></div>
    </div>
     <div class="w3-container w3-third w3-row">
        <div class="w3-col jacq-w50p"><br><?php makeDropdownDate(true); ?></div>
        <div class="w3-col jacq-w50p"><br><input class="w3-button w3-theme jacq-button-margin1" type="submit" name="prepareLabels" value="Labels">
        <input class="w3-button w3-theme" type="image" onclick="document.location.href='listSpecimensExport.php?select=labels&type=xlsx';return false;" name="labelsXLSX" src="webimages/disk.png" title="download Labels XLS"></div>
    </div>
    <?php if (checkRight('editor')):    // only editors may check logged in users ?>
     <div class="w3-container w3-third w3-row">
        <div class="w3-col jacq-w40p"><label><b>User:</b></label> <?php makeDropdownUsername(); ?></div>
        <div class="w3-col jacq-w30p"><label>&nbsp;</label><?php makeDropdownDate(); ?></div>
        <div class="w3-col jacq-w30p"><br><input class="w3-button w3-theme jacq-button-margin1" type="submit" name="selectUser" value="search"></div>
    </div>
    <?php endif; ?>
...
<td>
  ...
  <input class="w3-button w3-theme" type="submit" name="select" value=" Edit ">
</td><td style="width: 2em">&nbsp;</td><td>
  <?php makeDropdownDate(true); ?>
  <input class="w3-button w3-theme" type="submit" name="prepareLabels" value=" Labels ">
  <input class="w3-button w3-theme" type="image" onclick="document.location.href='listSpecimensExport.php?select=labels&type=xlsx';return false;" name="labelsXLSX" src="webimages/disk.png" title="download Labels XLS">
</td>
<?php if (checkRight('editor')):    // only editors may check logged in users ?>
<td style="width: 2em">&nbsp;</td><td>
  <b>User:</b> <?php makeDropdownUsername(); ?> <?php makeDropdownDate(); ?>
  <input class="w3-button w3-theme" type="submit" name="selectUser" value=" search ">
</td>
<?php endif; ?>
</tr></table>
</form>
...
if ($_SESSION['sType'] == 1) {
    if ($swBatch) {
        ...
        echo "<div class=\"w3-container w3-theme-l4\">\n<div class=\"w3-container w3-half\">\n <select class=\"w3-select w3-border jacq-button-margin\" name=\"batch\">\n";
        for ($i = 0; $i < count($batchValue); $i++) {
            echo "  <option value=\"" . $batchValue[$i] . "\">" . htmlspecialchars($batchText[$i]) . "</option>\n";
        }
        echo "</select>\n</div>\n"
           . "<div class=\"w3-container w3-half\">\n"
           . "<input class=\"w3-button w3-theme jacq-button-margin\" type=\"submit\" name=\"selectBatch\" value=\" insert selected specimen \">\n"
           . "\n"
           . "<input class=\"w3-button w3-theme jacq-button-margin\" type=\"button\" value=\" check all \" onclick=\"check_all()\">\n"
           . "</div>\n</div>\n";
    }
    ?>
    <div style="width: 100%;">
        <div style="float: right;">
            <select class="w3-select w3-border" id="items_per_page" onchange="listSpecimens();">
        ...
        <div id='specimen_entries'><div><img src="webimages/loader.gif"></div></div>
        <div class='specimen_pagination'></div>
    </div>
