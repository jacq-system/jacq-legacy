    ...
    if (strlen($sql2) == 0) {
        ...
        if (mysqli_num_rows($result) > 0) {
            echo "<div class=\"w3-container\">\n<div class=\"w3-responsive\">\n"
               . "<table class=\"w3-table-all w3-striped-jacq\" cellspacing=\"0\">\n"
               . "<tr class=\"w3-theme \">"
               . "<th class=\"jacq-th-border\"></th>"
               . "<th class=\"jacq-th-border\">"
               ...
               . "<th class=\"jacq-th-border\">Date</th>"
               . "<th class=\"jacq-th-border\">X/Y</th>"
               . "<th class=\"jacq-th-border\">Location</th>"
               . "<th class=\"jacq-th-border\">"
            ...
            if ($swBatch) {
                echo "<th class=\"jacq-th-border\">Batch</th>";
            }
            echo "</tr>\n";
            $nr = 1;
